...
namespace {
struct qt_meta_tag_ZN6oclero10qlementine13PopoverButtonE_t {};
} // unnamed namespace

template <> constexpr inline auto oclero::qlementine::PopoverButton::qt_create_metaobjectdata<qt_meta_tag_ZN6oclero10qlementine13PopoverButtonE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'popoverContentWidgetChanged'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'popoverOpenedChanged'
        QtMocHelpers::SignalData<void(bool)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 4 },
        }}),
        // Slot 'setPopoverOpened'
    ...
    return QtMocHelpers::metaObjectData<PopoverButton, qt_meta_tag_ZN6oclero10qlementine13PopoverButtonE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject oclero::qlementine::PopoverButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QPushButton::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6oclero10qlementine13PopoverButtonE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6oclero10qlementine13PopoverButtonE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6oclero10qlementine13PopoverButtonE_t>.metaTypes,
    nullptr
} };
...
void oclero::qlementine::PopoverButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PopoverButton::*)()>(_a, &PopoverButton::popoverContentWidgetChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (PopoverButton::*)(bool )>(_a, &PopoverButton::popoverOpenedChanged, 1))
            return;
    }
}
...
void *oclero::qlementine::PopoverButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6oclero10qlementine13PopoverButtonE_t>.strings))
