...
namespace {
struct qt_meta_tag_ZN6oclero10qlementine6SwitchE_t {};
} // unnamed namespace

template <> constexpr inline auto oclero::qlementine::Switch::qt_create_metaobjectdata<qt_meta_tag_ZN6oclero10qlementine6SwitchE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<bool>(6, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 2),
    };
    QtMocHelpers::UintData qt_enums {
    };
    return QtMocHelpers::metaObjectData<Switch, qt_meta_tag_ZN6oclero10qlementine6SwitchE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject oclero::qlementine::Switch::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6oclero10qlementine6SwitchE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6oclero10qlementine6SwitchE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6oclero10qlementine6SwitchE_t>.metaTypes,
    nullptr
} };
...
void oclero::qlementine::Switch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Switch::*)(int )>(_a, &Switch::checkStateChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Switch::*)(bool )>(_a, &Switch::tristateChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Switch::*)(bool )>(_a, &Switch::showAccessibilitySymbolsChanged, 2))
            return;
    }
...
void *oclero::qlementine::Switch::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6oclero10qlementine6SwitchE_t>.strings))
